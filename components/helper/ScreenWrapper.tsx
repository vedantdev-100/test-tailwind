...
export function ScreenWrapper({
    ...
    return (
        <SafeAreaView
            ...
            edges={edges}
        >
            {/* StatusBar — expo-status-bar handles both platforms correctly */}
            <StatusBar
                style={statusBarStyle}
                backgroundColor={resolvedStatusBarColor}
                hidden={statusBarHidden}
                // translucent lets the app draw edge-to-edge on Android;
                // SafeAreaView then pushes content below the bar via insets.
